          ...
          <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex items-center px-2 lg:px-0 xl:w-64">
              <div class="flex-shrink-0">
                <img class="h-10 w-auto" src="@/assets/logo-color.svg" alt="mkping">
              </div>
            </div>
                ...
                <div class="ml-4 relative flex-shrink-0">
                  <div>
                    <router-link
                     ...
                     :class="{'bg-dark-300':navigationData.activeNavigation === 'monitors'}">
                      Logout
                    </router-link>
                  </div>
                </div>
            ...
            <nav class="lg:mt-6">
              ...
              <div class="space-y-0 pb-6">
                ...
                <router-link
                   ...
                   class="group flex items-center mk-navigation-link"
                   :class="{'bg-dark-300':navigationData.activeNavigation === 'notifications'}">
                     <svg xmlns="http://www.w3.org/2000/svg"
